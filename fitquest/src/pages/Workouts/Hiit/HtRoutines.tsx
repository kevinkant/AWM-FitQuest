...
const HtRoutines: React.FC = () => {
    ...
    const [routine, setRoutine] = useState<string>('Beginner routine');
    ...
    useEffect(() => {
        ...
        firestore.collection("Hiit routines")
            .where("Name", '==', `${routine}`)
            .get()
            .then((querySnapshot) => {
        ...
        <IonPage>
            ...
            <IonItem>
                ...
                <IonSelect value={routine} okText="Okay" cancelText="Dismiss" onIonChange={e => setRoutine(e.detail.value)}>
                    ...
                    <IonSelectOption value="Beginner routine">Beginner routine</IonSelectOption>
                    <IonSelectOption value="Intermediate routine">Intermediate routine</IonSelectOption>
